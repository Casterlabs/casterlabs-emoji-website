                            ...
                            {#if emoji.variations.def.assets[emojiProvider].supported}
                                <span class="emoji-container">
                                    <a
                                        on:click={() => {
                                            ...
                                            if (hasVariations && !userVariation) {
                                                ...
                                                let variation = emoji.variations.def;

                                                if (userVariation) {
                                                    const user = emoji.variations[userVariation];

                                                    if (user.assets[emojiProvider].supported) {
                                                        variation = user;
                                                    }
                                                }
                                    ...
                                    {#if contextMenuOpenOn == emoji.variations.def.sequence}
                                        <span bind:this={contextMenuElement} class="emoji-context-menu-container" class:remove-brr={contextMenuRemoveBRR} style="--shift: {contextMenuOffset}px;">
